...
En los dos apartados anteriores hemos visto como las variables RestingBP y Cholesterol tenían valores vacíos y como la variable MaxHR tenía valores extremos que no cuadraban.
<br>
Para ello, pusimos eso valores como pérdidos (NA).
